import CalculateOneSleepCycleBeforeService from "../services/CalculateOneSleepCycleBeforeService.js";
...
export default class TabWakeUp extends Tab {
  ...
  setup() {
    ...
    const setNewService = (event) => {
      let baseTime = event.target.value;
      this.addOutputToDOM("#times-sleep", new CalculateOneSleepCycleBeforeService({baseTime}), numberOfOutputs);
    };
